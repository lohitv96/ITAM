...
R2_SRM = np.load('data_non_stationary/R2_SRM.npy')
R2_BSRM = np.load('data_non_stationary/R2_BSRM.npy')
R3_SRM = np.load('data_non_stationary/R3_SRM.npy')
R3_BSRM = np.load('data_non_stationary/R3_BSRM.npy')
