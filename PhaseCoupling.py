...
ax.set_zlabel('Target $\Re{B(F_1, F_2)}$')
plt.show()
...
ax.set_xlabel('$F_1$(Hz)')
ax.set_ylabel('$F_2$(Hz)')
ax.set_zlabel('Target $\Im{B(F_1, F_2)}$')
plt.show()

# Plotting the Amplitude Bispectrum
fig = plt.figure()
ax = fig.gca(projection='3d')
ax.plot_surface(Fx, Fy, B_Ampl)
plt.title('Target Amplitude Bispectrum')
ax.set_xlabel('$F_1$(Hz)')
ax.set_ylabel('$F_2$(Hz)')
ax.set_zlabel('Target $B(F_1, F_2)$')
plt.show()
...
# Plotting the Biphase
fig = plt.figure()
ax = fig.gca(projection='3d')
ax.plot_surface(Fx, Fy, Biphase)
plt.title('Target Bipahase')
ax.set_xlabel('$F_1$(Hz)')
ax.set_ylabel('$F_2$(Hz)')
ax.set_zlabel('Target $Biphase(F_1, F_2)$')
plt.show()
...
# Mu_11 = 0
# Kappa_11 = 0
# biphase_11 = np.random.vonmises(Mu_11, Kappa_11, numsample, 1)
...
# Plotting the biphase random variates
plt.figure(2)
ax = plt.subplot(111, polar=True)
...
# Mu_22m1 = 0
# Kappa_22m1 = 1
# triphase_22m1 = vmrand(Mu_22m1, Kappa_22m1, numsample, 1)
#
# theta_3 = theta_2 + theta_2 - theta_1 + triphase_22m1

# # case2
# beta_21 Von Mises RV.
# Mu_21 = np.pi
# Kappa_21 = 10
# biphase_21 = np.random.vonmises(Mu_21, Kappa_21, numsample)

# Wrapped Cauchy RV.
Mu_21 = 0
rho_21 = np.sqrt(0.5)
biphase_21 = stats.wrapcauchy.rvs(rho_21, size=numsample)
...
ax.set_title('Estimated PDF of $\Phi_{21}$')
plt.show()

plt.figure(5)
ax = plt.subplot(111, polar=True)
ax.hist(theta_3, bins=100, normed='True')
ax.set_title('Estimated PDF of $\Theta_3$')
plt.show()

plt.figure()
ax = plt.subplot(111, polar=True)
ax.hist(theta_3 - theta_2 - theta_1, bins=100, normed='True')
ax.set_title('Validated PDF of $\Phi_{21}$')
plt.show()
...
Mu_22 = 0
rho_22 = np.sqrt(0.5)
biphase_22 = stats.wrapcauchy.rvs(rho_22, size=numsample)
theta_4_22 = theta_2 + theta_2 + biphase_22

plt.figure()
ax = plt.subplot(111, polar=True)
ax.hist(biphase_22, bins=100, normed='True')
ax.set_title('Estimated PDF of $\Phi_422$')
plt.show()

plt.figure()
ax = plt.subplot(111, polar=True)
ax.hist(theta_4_22, bins=100, normed='True')
ax.set_title('Estimated PDF of $\Theta_422$')
plt.show()

Mu_31 = 0
rho_31 = np.sqrt(0)
# biphase_31 = stats.wrapcauchy(rho_31, size=numsample)
biphase_31 = np.random.uniform(-np.pi, np.pi, size=numsample) + Mu_31
theta_4_31 = theta_3 + theta_1 + biphase_31

plt.figure()
ax = plt.subplot(111, polar=True)
ax.hist(biphase_31, bins=100, normed='True')
ax.set_title('Estimated PDF of $\Phi_431$')
plt.show()

plt.figure()
ax = plt.subplot(111, polar=True)
ax.hist(theta_4_31, bins=100, normed='True')
ax.set_title('Estimated PDF of $\Theta_431$')
plt.show()

theta_4 = 0.5*(theta_4_22 + theta_4_31)
